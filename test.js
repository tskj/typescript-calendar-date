...
console.log(calendar_date_1.calendarDateLessThan({
...
console.log(calendar_date_1.calendarDatesEqual({ year: 2020, month: 'feb', day: 2 }, { year: 2020, month: 'feb', day: 2 }));
console.log(calendar_date_1.numberOfCalendarDaysBetween({
